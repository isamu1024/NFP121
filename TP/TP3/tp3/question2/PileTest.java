...
public class PileTest extends junit.framework.TestCase {
    ...
    public void testStringEqualsInteger() throws Exception {
        Pile pString = new question2.Pile(2);
        Pile pInteger = new question2.Pile(2);
    ...
    public void testPileVide() throws Exception {
        ...
        Pile pileVide1 = new question2.Pile();
        Pile pileVide2 = new question2.Pile();
        
        assertTrue("égalté de 2 piles vide ?", pileVide1.equals(pileVide2));
        
        pileVide2.empiler(1);
        
        assertFalse("égalté de 2 piles vide ?", pileVide1.equals(pileVide2));
