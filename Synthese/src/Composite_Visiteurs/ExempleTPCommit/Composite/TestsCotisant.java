...
public class TestsCotisant extends junit.framework.TestCase {
    ...
    public void testEnonce() {
        ...
        assertTrue(" solde erroné ??? ", c.getSolde() == 100);
        final int val = 30;
        try {
            c.debit(val);
        } catch (Exception e) {
        ...
        assertTrue(" débit inopérant ??? ", c.getSolde() == 100 - val);
        c.credit(val);
        assertTrue(" crédit inopérant??? ", c.getSolde() == 100);
        ...
        assertEquals(" solde erroné ??? ", 300, g.getSolde());
        ...
        assertEquals(" débit inopérant ??? ", 300 - (g.nombreDeCotisants() * 10), g.getSolde());
        assertEquals(" solde erroné ??? ", 270, g.getSolde());
        ...
        assertEquals(" solde erroné ??? ", 210, g.getSolde());
    ...
    public void testUnGroupeDeContributeurs() {
        try {
            ...
            assertTrue(" solde erroné ??? ", c.getSolde() == c.nombreDeCotisants() * 100);
            final int val = 30;

            c.debit(val);
            assertTrue(" débit inopérant ??? ", c.getSolde() == (c.nombreDeCotisants() * 100) - (c.nombreDeCotisants() * val));
            c.credit(val);
            assertTrue(" crédit inopérant??? ", c.getSolde() == c.nombreDeCotisants() * 100);
    ...
    public void testPlusieursGroupesDeContributeurs() {
        try {
            ...
            assertTrue(" solde erroné ??? ", g2.getSolde() == g2.nombreDeCotisants() * 100);
            final int val = 30;

            g2.debit(val);
            assertTrue(" débit inopérant ??? ", g2.getSolde() == (g2.nombreDeCotisants() * 100) - (g2.nombreDeCotisants() * val));
            g2.credit(val);
            assertTrue(" crédit inopérant??? ", g2.getSolde() == g2.nombreDeCotisants() * 100);
    ...
    public void testGetParentSurUnGroupe() {
        try {
            ...
            assertTrue(" parent incorrect ??? ", a1.getParent().getNom().equals(g1.getNom()));
            GroupeDeContributeurs g2 = new GroupeDeContributeurs("g2");
            ...
            assertTrue(" parent incorrect ??? ", b.getParent().getNom().equals(g2.getNom()));
            // 	    g2.ajouter(g0);
    ...
    public void testUnGroupeAvecUnSoldeDebiteurDuPremierContributeur() {
        try {
            ...
            assertTrue(" solde erroné ??? ", g.getSolde() == 600);
            ...
            assertTrue(" à la question3 seulement l'atomicité est souhaitée ", a.getSolde() == 100);
            assertTrue(" à la question3 seulement l'atomicité est souhaitée ", b.getSolde() == 200);
            assertTrue(" à la question3 seulement l'atomicité est souhaitée ", c.getSolde() == 300);
            assertTrue(" solde erroné ??? ", g.getSolde() == 600);
    ...
    public void testUnGroupeAvecUnSoldeDebiteurDuDernierContributeur() {
        try {
            ...
            assertTrue(" à la question3 seulement l'atomicité est souhaitée ", a.getSolde() == 180);
            assertTrue(" à la question3 seulement l'atomicité est souhaitée ", b.getSolde() == 80);
            assertTrue(" à la question3 seulement l'atomicité est souhaitée ", c.getSolde() == 100);
            assertTrue(" solde erroné ??? ", g.getSolde() == (180 + 80 + 100));
    ...
    public void testUnGroupeAvecTousLesSoldesDebiteurs() {
        try {
            ...
            assertTrue(" solde erroné ??? ", c.getSolde() == 600);
            final int val = 30;

            c.debit(val);
            assertTrue(" débit inopérant ??? ", c.getSolde() == 600 - (c.nombreDeCotisants() * val));
            c.credit(val);
            assertTrue(" crédit inopérant??? ", c.getSolde() == 600);
    ...
    public void testVisiteurSurUnGroupe() {
        try {
            ...
            Iterator<Cotisant> it = g.iterator();
            assertTrue(" est-ce le bon Contributeur ???", it.next().getNom().equals("a"));
            assertTrue(" est-ce le bon Contributeur ???", it.next().getNom().equals("b"));
            assertTrue(" est-ce le bon Contributeur ???", it.next().getNom().equals("c"));
