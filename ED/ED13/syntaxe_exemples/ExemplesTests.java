...
public class ExemplesTests extends junit.framework.TestCase{
    ...
    public void testAvecInjection() throws Exception{
       ...
       public void testTableAvecInjectionJson() throws Exception{
        ApplicationContext ctx = container.Factory.createApplicationContext("./syntaxe_exemples/table.json");
