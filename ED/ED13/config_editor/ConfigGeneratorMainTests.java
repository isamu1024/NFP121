...
public class ConfigGeneratorMainTests{
   ...
   public static void testConfigGeneratorGUISwingFormatter1() throws Exception{
       IConfigGenerator  configGenerator = new ConfigGenerator();
   ...
   public static void testConfigGeneratorGUISwingFormatter2() throws Exception{
       IConfigGenerator  configGenerator = new ConfigGenerator();
       Formatter formatter = new SwingPropertiesFormatter();
       configGenerator.setFormatter(formatter);
       configGenerator.setBeanName("exemples");
       configGenerator.setBeanClassFileName("syntaxe_exemples/");
       configGenerator.analyze();
       System.out.println(configGenerator.getFormatter().get());
   }
   
   public static void testConfigGeneratorGUISwingFormatter3() throws Exception{
       IConfigGenerator  configGenerator = new ConfigGenerator();
       Formatter formatter = new SwingPropertiesFormatter();
       configGenerator.setFormatter(formatter);
       configGenerator.setBeanName("decorator");
       configGenerator.setBeanClassFileName("decorator/");
       configGenerator.analyze();
       System.out.println(configGenerator.getFormatter().get());
   }
   ...
   public static void main(String[] args) throws Exception{
        ...
        // qui pourrait affecter les valeurs des attributs et engendrer le fichier de configuration final
