...
public class InfoStation implements Serializable{
  ...
  private final static boolean D = false; // D comme mode dégradé
...
//   </station>
  ...
  public InfoStation(int numeroDeStation){
    ...
    try{
      if(D)throw new Exception(); // en mode dégradé d'emblée: exception...
      ...
      copierDansUnFichier(numeroDeStation,url.openStream()); // sauvegarde au cas où
       ...
       // en mode dégradé, prenons les dernières valeurs sauvegardées depuis un fichier xml
       // trop de requêtes sur http://www.velib.paris.fr/service/ induit 
